...
namespace Microsoft.DigitalWorkplace.Integration.Models.DigitalTwins
{
    ...
    public static class Extensions
    {
        ...
        {
            var hash = 1009;
            foreach (var i in values.Where(v => v.HasValue))
            {
        ...
        internal static bool DictionaryEquals<TKey, TValue>(this IDictionary<TKey, TValue> left, IDictionary<TKey, TValue> right, EqualityComparer<TValue> valueComparer = default)
        {
