...
namespace Microsoft.CSE.EUSE.ADT.UnitTests
{
    using System;
    ...
    {
        private readonly JsonSerializerOptions options = new JsonSerializerOptions { IgnoreNullValues = true };
        ...
        public void CanAccessModelStaticMetadata()
        {
            ...
            Assert.IsTrue(staticValue.StartsWith("dtmi:microsoft:Space;"));
        }
        ...
        public void CanAccessModelInstanceMetadata()
        {
            ...
            Assert.IsTrue(instanceValue.StartsWith("dtmi:microsoft:Space;"));
        }
        ...
        public void CanAccessModelSubclassInstanceMetadata()
        {
            ...
            var instanceValue = model.Metadata.ModelId;
            Assert.IsTrue(instanceValue.StartsWith("dtmi:microsoft:Space:Building;"));
        }
        ...
        public void CanAccessModelSubclassStaticMetadata()
        {
            ...
            Assert.IsTrue(staticValue.StartsWith("dtmi:microsoft:Space:Building;"));
        }
        ...
        public void ModelRelationshipPropertiesAreInitializedOnlyOnce()
        {
            ...
            var address1 = new Address { ExternalId = 1, Street1 = "123 St", Street2 = "abc", County = "king", Zipcode = "1001" };
            var address2 = new Address { ExternalId = 1, Street1 = "456 St", Street2 = "def", County = "snohomish", Zipcode = "2001" };
        ...
        public void ModelSerializesCorrectly()
        {
            ...
            var actualJsonWithoutNulls = JsonSerializer.Serialize(building, new JsonSerializerOptions { IgnoreNullValues = true });
